...
namespace Proyecto_Web_ll.Controllers
{
    public class ContactoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Id_Cliente,Nombre,Apellido_Uno,Telefono,Correo,Puesto")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Id_Cliente,Nombre,Apellido_Uno,Telefono,Correo,Puesto")] Contacto contacto)
        {
            if (id != contacto.ID)
            {
                return NotFound();
